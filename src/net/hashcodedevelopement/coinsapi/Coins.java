		...
		if (sender instanceof Player) {
			...
			if (args.length == 0) {
				if (coinsAPI.exist(player.getUniqueId())) {
					player.sendMessage(prefix + "Coins: §a" + coinsAPI.getCoins(player.getUniqueId()));
				} else {
					coinsAPI.create(player.getUniqueId());
					...
					if (args[0].equalsIgnoreCase("add")) {
						...
						if (r != null) {
							if (Pattern.matches("[a-zA-Z]+", args[2]) == false) {
								...
								player.sendMessage(prefix + "§8§l§a§l+ §6§l" + args[2] + "§8§l]");
							}
						}
						...
						if (r != null) {
							if (Pattern.matches("[a-zA-Z]+", args[2]) == false) {
								...
								player.sendMessage(prefix + "§8§l§c§l- §6§l" + args[2] + "§8§l]");
							}
						}
						...
						if (r != null) {
							if (Pattern.matches("[a-zA-Z]+", args[2]) == false) {
								...
								player.sendMessage(prefix + "§8§l§e§l= §6§l" + args[2] + "§8§l]");
							}
						}
					}
				}
				if (args[0].equalsIgnoreCase("pay")) {
					...
					if (r != null) {
						if (Pattern.matches("[a-zA-Z]+", args[2]) == false) {
							coinsAPI.setCoins(r.getUniqueId(), Integer.parseInt(args[2]));
							player.sendMessage(prefix + "§8§l§c§l- §6§l" + args[2] + "§8§l]");
							r.sendMessage(prefix + "§8§l§a§l+ §6§l" + args[2] + "§8§l]");
						}
					}
				}
			}
